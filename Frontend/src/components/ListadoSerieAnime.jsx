              ...
              <div key={i} className="portada-box">
                <h2 className="portada-title">
                  <a title={x.Titulo} href={"http://"+this.ipPc+":3000/Video?id="+x.Id+"&cap=1"} rel="bookmark">
                    {x.Titulo} 
                    {(x.Idioma.indexOf('Latino') !== -1 ? <img title="Latino" alt="serie anime" src={require("../images/Latino.png")}/> : '')} 
                    {(x.Idioma.indexOf('Subtitulado') !== -1 ? <img title="Subtitulado" alt="serie anime" className="sub" src={require("../images/Subtitulado.png")}/> : '')} 
                    </a>
                </h2>
