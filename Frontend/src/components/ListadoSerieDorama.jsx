              ...
              <div key={i} className="portada-box">
                <h2 className="portada-title">
                  <a title={x.Titulo} href={"http://"+this.ipPc+":3000/Video?id="+x.Id+"&cap=1"} rel="bookmark">
                    ...
                    {x.Idioma.map((idi, u) => {
                      return (
                        idi.toLowerCase() === 'latino' ? <img key={u} title="Latino" alt="serie dorama" style={{"paddingRight":"3px"}} src={require("../images/Latino.png")}/> : 
                        idi.toLowerCase() === 'subtitulado' ? <img key={u} title="Subtitulado" alt="serie dorama" style={{"paddingRight":"3px"}} src={require("../images/Subtitulado.png")}/> : 
                        <img key={u} title={idi} alt="serie dorama" style={{"paddingRight":"3px"}} src={require("../images/Desconocido.png")}/>
                      )
                    })}
                    </a>
                </h2>
