            ...
            (<li key={i}>
              <a className={this.state.opt === idi ? 'options selected' : 'options noselected'} href="" onClick={this.seleccionarIdioma}>
                ...
                <span className="dt_flag">                
                  <img title="Latino" alt="video" style={{"paddingRight":"3px"}} src={require("../images/Latino.png").default}/>
                </span>
              </a>
            </li>)
            : idi.toLowerCase() == 'subtitulado' ? 
              (<li key={i}>
                <a className={this.state.opt === idi ? 'options selected' : 'options noselected'} href="" onClick={this.seleccionarIdioma}>
                  <b className="icon-play_arrow"></b>{idi} 
                  <span className="dt_flag">                
                    <img title="Subtitulado" alt="video" style={{"paddingRight":"3px"}} src={require("../images/Subtitulado.png").default}/>
                  </span>
                </a>
              </li>)
              : (<li key={i}>
                  <a className={this.state.opt === idi ? 'options selected' : 'options noselected'} href="" onClick={this.seleccionarIdioma}>
                    <b className="icon-play_arrow"></b>{idi} 
                    <span className="dt_flag">                
                      <img title={idi} alt="video" style={{"paddingRight":"3px"}} src={require("../images/Desconocido.png").default}/>
                    </span>
                  </a>
                </li>)
        )
